<!--
  context-menu-radio-item.svelte — vendored shadcn-svelte ContextMenu.RadioItem.
  Wraps bits-ui ContextMenuPrimitive.RadioItem with the filled-circle glyph.
  Vendored 2026-07-10 with the paw frosted-popover canon.
-->
<script lang="ts">
