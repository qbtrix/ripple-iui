<!--
  ...
  carrying the paw frosted-popover canon (bg-popover trips the global blur +
  popover-border rules). Wraps bits-ui ContextMenuPrimitive.SubContent.
  Vendored 2026-07-10 (feat/canonical-menubar-contextmenu).
-->
<script lang="ts">
