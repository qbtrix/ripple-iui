...
// while keeping the master-item customization cliff (list items support only
// valueKey/labelKey/descriptionKey/badgeKey; bespoke list cards need a hand-rolled grid).
