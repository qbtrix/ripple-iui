...
//     '[unserializable]'.
//   - 2026-09-17 (ripple #119 merge of main): moved from @ripple-ui/svelte's
//     widgets/ into @ripple-ui/core. The oxlint sweep made the engine's
//     event-dispatcher and expression-resolver call asText, and core cannot
//     import from the renderer. Svelte's widgets/text-coerce.ts re-exports it.
