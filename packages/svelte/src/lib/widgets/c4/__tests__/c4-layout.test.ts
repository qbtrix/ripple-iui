...
// The TYPES come from c4/types.ts. `c4/index.ts` exports a COMPONENT also
// called C4Diagram, so importing them from the barrel silently resolves to
// the component's props type and every literal below fails to type-check.
import type {
  C4Diagram,
  C4Person,
  C4System,
