// packages/svelte/src/lib/widgets/overlay/CommandPalette.test.ts
// Updated: 2026-09-24 — moved with the monorepo split; the drain now lives in
//   packages/svelte/src/test-setup.ts. No test logic changed.
