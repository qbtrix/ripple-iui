<!--
  context-menu-sub-trigger.svelte — vendored shadcn-svelte ContextMenu.SubTrigger.
  Wraps bits-ui ContextMenuPrimitive.SubTrigger with the canonical accent
  treatment + a trailing chevron. Vendored 2026-07-10 with the paw
  frosted-popover canon.
-->
<script lang="ts">
