<!--
  ...
  in tokens — bg-ripple-popover text-ripple-popover-foreground backdrop-blur-md
  ring-1 ring-ripple-border.
  2026-09-17 (fix/port-gaps): fill moved off bg-ripple-surface. That aliases the
  host's --card, an in-flow card tint (6% white in paw-enterprise dark), so page
  text read through the menu; --ripple-popover aliases --popover, the host token
  made for a layer over content. Originally vendored 2026-07-10 (feat/canonical-menubar-contextmenu).
-->
<script lang="ts">
